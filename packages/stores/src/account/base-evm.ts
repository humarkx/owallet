...
// import { request } from '@owallet/background/build/tx/service';
...
// export interface AccountSetEvmOpts<MsgOpts> {
...
// export class AccountSetEvmBase<MsgOpts, Queries> {
//     //   @observable
...
//         protected readonly opts: AccountSetEvmOpts<MsgOpts>
//     ) {
//         makeObservable(this);
...
//     //   protected async enable(ethereum: Ethereum, chainId: string): Promise<void> {
//     //     console.log("Enable!!!!!!!!!!!!")
//     //     const chainInfo = this.chainGetter.getChain(chainId);

//     //     if (this.opts.suggestChain) {
//     //       if (this.opts.suggestChainFn) {
//     //         await this.opts.suggestChainFn(ethereum, chainInfo);
//     //       } else {
//     //         await this.suggestChain(ethereum, chainInfo);
//     //       }
//     //     }
//     //     await ethereum.enable(chainId);
//     //   }
...
//         // const ethereum = yield* toGenerator(this.getEthereum());
//         // if (!ethereum) {
//         //   this._walletStatus = WalletStatus.NotExist;
//         //   return;
//         // }

//         // this._walletVersion = ethereum.version;

//         // try {
//         //   yield this.enable(ethereum, this.chainId);
//         // } catch (e) {
//         //   console.log(e);
...
//         // const key = yield* toGenerator(ethereum.getKey(this.chainId));
...
//             this.walletStatus === WalletStatus.Loaded
//         );
//     }
...
//         txHash: Uint8Array;
//     }> {
//         console.log("REACH broadcast MSG!!!!!!!!!!!!!!!!!!!!!!!")
...
//         console.log("REACH BROADCAST MSG PHASE 2!!!!!!!!!!!!!!")
...
//             console.log("Has no legacy std feature!!!!!!!!!!!!!!!")
//             const key = await owallet.getKey(this.chainId);
...
//             }).finish();
//         } else {
//             console.log("Has legacy feature!!!!!!!!!!!!!")
