...
export interface AccountEthSetOpts<MsgOpts> {
...
export class AccountEthSetBase<MsgOpts, Queries> {
  @observable
  ...
  constructor(
    ...
    protected readonly opts: AccountEthSetOpts<MsgOpts>
  ) {
    makeObservable(this);
...
//   }
  ...
  protected async broadcastMsgs(
    ...
    console.log(ethereum, 'ETHEREUM WALLET!!!!!!!!!!!!!!!!')
    ...
    if (chainInfo.networkType === "evm") {
      ...
      console.log(signResponse,'RESPONSE SIGN!@!!!!!!!!!!!!!!')
    }
